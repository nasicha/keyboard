<template>
  <span class="text-base text-xs underline">Disclaimer:</span>
  <p class="text-background text-xs"> This prototype was build for a bachelorthesis between February and August 2023. It mainly uses VueUse 
  <a class="underline hover:text-base hover:text-xs" href="https://vueuse.org/core/useGamepad/" target="_blank">useGamepad</a> 
